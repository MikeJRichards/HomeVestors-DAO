...
module{
    ...
    // ====================== IMAGES ======================
public func createImageTestType2(property: PropertyUnstable, handlePropertyUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResultExternal):async [Text] {
    type C = Text;
    type U = Text;
...
// PHYSICAL DETAILS
public func createPhysicalDetailsTestType2(property: PropertyUnstable, handlePropertyUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResultExternal) : async [Text] {
