...
window.data = data
  ...
  { dataRole: "purchasePrice", data: currency(data.financials.investment.purchasePrice)},
  ...
  { dataRole: "nftLegals", data: "no data" },
  { dataRole: "nftStamp", data: "no data" },
  ...
  { dataRole: "legals", data: "no data"},
  { dataRole: "stamp", data: "no data"},
  ...
  { dataRole: "nftPurchasePrice", data: currency(Number(data.financials.investment.totalInvestmentValue) / 1000)},
];
