...
module{
    ...
    // ====================== FIXED PRICE ======================
public func createFixedPriceTestType2(property: PropertyUnstable, handlePropertyUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResult): async [Text] {
...
// ====================== AUCTION ======================
public func createAuctionTestType2(property: PropertyUnstable, handlePropertyUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResult): async [Text] {
...
public func createBidHandlersTest(property: PropertyUnstable, handleUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResult): async [Text] {
    type C = Types.BidArg;
    type T = Types.Listing;
    func createBidArg(): C {
        {
