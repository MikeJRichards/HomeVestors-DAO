...
module{
    ...
    public func createNoteTestType2(property: PropertyUnstable, handlePropertyUpdate: (WhatWithPropertyId, Principal) -> async UpdateResult): async [Text] {
...
public func createInsuranceTestType(property: PropertyUnstable, handlePropertyUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResult): async [Text] {
...
public func createDocumentTestType2(property: PropertyUnstable, handlePropertyUpdate: (Types.WhatWithPropertyId, Principal) -> async Types.UpdateResult): async [Text] {
